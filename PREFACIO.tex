...
atractiva} de uma \textit{cidade eterna} como Roma, ou de uma \textit{cidade luz}
...
ocorreu durante o Festival Labas, realizado na Casa Museu.
...
de 1937. Nesse testamento, que consta dos arquivos da Fundação Ema Klabin, Hessel
...
\textit{litvaks}, que fizeram de \textit{Vilnè}, a \textit{Jerusalém da Lituânia}, como já
...
\textit{hassidim}. Tem, entre seus componentes significativos, a
...
o Holocausto, da \textit{Jerusalém da Lituânia}. O poeta da língua iídiche e
...
sensibilidade Laimonas Briedis em seu já mencionado livro \textit{Cartografia poética}.
...
judeus. ``Sem misericórdia na nuvem acima de Ponar'' é como ela aparece no
poema ``Adeus'', de Sutzkever.\footnote{\textit{Apud} Laimonas Briedis.
  \textit{Poetic Cartography}, \textit{op. cit.}, p. 175. Na edição original, o poema grafado ``Farewell'' diz ``No mercy in the cloud above Ponar''.} No poema de
Miłosz, ``Cidade sem nome'', que já evoquei, a passagem que cabe
lembrar é: ``O chifre de pastor envolvido na casca da bétula/\,Soará nas colinas de Ponar a memória dos ausentes?''.\footnote{Czeslaw
  Miłosz. \textit{Selected and Last Poems -- 1931--2004}, \textit{op.
  cit.}, p. 261. Na edição original, ``What shepherd's horn swathed in the bark of birch/\,Will
sound in the Ponary Hills the memory of the absent?''}
...
Vilnius: \textit{o retorno de Lasar Segall}. A exposição foi uma iniciativa do
...
\textit{Um modernista brasileiro de} Vilnius.
...
memória da \textit{Jerusalém da Lituânia}, o que propiciou uma visão concreta de
...
do fim da \textit{Jerusalém da Lituânia} que ele presenciou, cuja existência no
passado integra a narrativa de Laimonas Briedis.

Em minha viagem de 2019, recebi o álbum"-catálogo de
...
álbum"-catálogo impacta. Visualiza relances da resiliência
