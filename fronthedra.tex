...
\ifdef\selectfont\minion{\tradutor}{{\small {\tradutor} (\textit{tradução})}\par}{}\vspace{4em}

{{\small{} \ifdef{\numeroedicao}{\numeroedicao}{1}ª edição} \par}

%logos
\vfill
\ifdef{\logo}{\IfFileExists{\logo}{\hfill\includegraphics[width=3cm]{./logo.png}\hfill\logoum{}\\ São Paulo\quad2021}}{\includegraphics[width=3cm]{./logo.png}\break{}\medskip São Paulo\quad2021}
