...
\linhalayout{título original}{\emph{Vilnius: City of Strangers}, 2009}
...
\vfill\textit{The translation of this book was supported by Lithuanian Culture Institute}\bigskip
...
%logos
\vfill
\ifdef{\logo}{\IfFileExists{\logo}{\hfill\includegraphics[width=3cm]{./logo.png}\hfill\logoum{}\\ São Paulo\quad2020}}{\includegraphics[width=3cm]{./logo.png}\break{} São Paulo\quad2020}
