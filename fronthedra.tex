...
%logos
\vfill
\ifdef{\logo}{\IfFileExists{\logo}{\hfill\includegraphics[width=3cm]{./logo.png}\hfill\logoum{}\\ São Paulo\quad2021}}{\includegraphics[width=3cm]{./logo.png}\break{} São Paulo\quad2021}
