...
\linha{\textsc{isbn}}{\ISBN}\smallskip
...
\includegraphics[height=3cm]{./logolituania.jpg} \includegraphics[height=3cm]{./logogaon.jpg}

\medskip

\linha{sobre o fomento à tradução}{\patrociniomensagem}

\bigskip

\vfill\textit{Direitos reservados em l\'ingua\\ portuguesa somente para o Brasil}
...
\titulagem
\bigskip
{\Formular\bfseries\Large \autor \par\vspace{1.5em}}
% \ifdef{\organizador}{{\small {\organizador} (\textit{organização})} \par}{}
\newfontfamily\minion{Minion Pro}
              %{\fontsize{30}{40}\selectfont \minion
\ifdef\selectfont\minion{\tradutor}{{\small {\tradutor} (\textit{tradução})} \par}{}
\ifdef{\prefacio}{{\small {\prefacio} (\textit{prefácio})}\par}{}\vspace{4em}

{{\small{} \ifdef{\numeroedicao}{\numeroedicao}{1}ª edição} \par}

%logos
\vfill
\ifdef{\logo}{\IfFileExists{\logo}{\hfill\includegraphics[width=2.5cm]{./logo.png}\hfill\logoum{}\\ São Paulo\quad2021}}{\includegraphics[width=2.5cm]{./logo.png}\\\smallskip São Paulo\quad2021}
