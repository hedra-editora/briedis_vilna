...
cartografadas.}{\textsc{johannes bobrowski}, \textit{Precaução}}
\end{epigraphs}
...
centro da Europa em 54º\,54'\,\textsc{n} e 25º\,19'\,\textsc{l}. Exatamente nestas
...
de Bernotai, cerca de 25 quilômetros ao norte de Vilna.
...
ratificada, dista cerca de 30 quilômetros a leste da capital
lituana, situando o centro do continente bem perto da Bielorrússia, em
...
O Papa João \textsc{xxii}, francês de origem modesta, foi eleito em 1316 para
...
encontro com um discurso improvisado sobre o caráter dúplice da fé
...
40 anos de idade, e a rainha da Polônia, Jadwiga, de 12 anos. Ao
...
Vytautas como ``um monarca muito poderoso, que conquistou 12 ou 13
...
com 13 anos, foi enviado por seu pai à Hungria para reivindicar o
...
onde escreveu um poema de 16 versos, intitulado ``De Lithuania'',
...
Lituânia abarcava os territórios da atual Lituânia, Bielorrússia, Ucrânia
...
escapar mediante o pagamento de uma multa de 16 táleres. Mas se
...
de memórias reais e ficcionalistas do passado. Nesse sentido, a
...
século \textsc{xviii}, numa cidade de menos de 40 mil habitantes, havia 32 
igrejas católicas com 15 mosteiros, cinco igrejas
...
A Sarmácia tombou, sem pranto, sem um só crime.}{\textsc{thomas campbell}, \textit{Polônia}}
\end{epigraphs}
...
\textit{Wilna} se localiza a cerca de mil e cem quilômetros a nordeste de Kassel. No
...
William Coxe,\footnote{William Coxe nasceu em 1747 e morreu em 1828.} inglês experiente, em 1778 atravessou a
...
%     \caption{Retrato de 1812 da Grande Armée em Vilna, a partir da pintura de \textsc{j}.\,Damel.}
% \end{figure}
...
Forster demonstrou ainda menor interesse pelo lado judaico
...
expedição aos mares do Sul.''\footnote{Forster escreve para Herder, 1º de setembro de 1787, \textit{Georg Forsters Werke 15}. Berlim: Akademie Verlag, 1981, p. 32.} Havia, contudo, um sério obstáculo aos planos de Forster -- o senado da universidade não queria
...
movimento -- Paris -- e se aquieta.}{\textsc{liev tolstói}, \textit{Guerra e paz}\footnotemark}
\end{epigraphs}
...
listaram ainda 32 igrejas católicas, 15 mosteiros, cinco igrejas
greco"-católicas com três mosteiros, uma igreja ortodoxa russa, uma igreja
...
medicina moderna. Embora talvez enervassem alguns colegas e farmacêuticos
...
sentido de \textit{racializar} o conhecimento médico. Em pelo menos uma ocasião,
...
se ergue radiante por cima de 36 conventos.''\footnote{Marie Charlotte Oudinot, \textit{Récites de guerre et de Foyer}, conforme citado em Austin, \textit{1812: the March to Moscow}, p. 70.}
...
termômetro marcando 16 ou 17 abaixo de 0,\footnote{Equivalente a -27 ou -28
...
\begin{quote}
Se tivéssemos podido ficar mais 24 horas em Vilna, muitas
vidas teriam sido salvas. Essa cidade mortífera nos custou 20 mil
...
Nos arredores ocidentais da cidade, na colina Ponari, a carnificina
...
Quando, após 15 horas de luta inútil, os cocheiros e soldados da
...
imperial: ``Apresentei"-me diante de Sua Serena Alteza no dia 1º de
...
inverno porém; sem lareira, um único fogão, de modo que há 18 graus
...
imundície, e 20 graus de gelo, foram os incidentes da manhã. O
...
quinze dias, 9 mil prisioneiros morreram e, só em 18 horas,
...
chegaram sãos e salvos a Vilna mas, na colina Ponari, foram atacados
...
deleitar"-me com meu próprio enternecimento.}{\textsc{fiódor dostoiévski}, \textit{Os irmãos Karamázov}\footnotemark}
\end{epigraphs}
...
Entre os judeus, \textit{Vilnè} ficou conhecida como \textit{Yerushalaim
...
pequenas cidades desempenhavam também importantes papéis: \textit{yeshivot}
...
a colina Paneriai, também conhecida como Ponari. Durante séculos, quem quer que chegasse à
...
O dramaturgo russo Aleksandr Ostrovsky\footnote{Ostrovsky nasceu em 1823 e morreu em 1886} visitou Vilna na
...
madrugada, às 15 para as 2, Fedya teve uma crise, muito forte;
durou 15 minutos. [\ldots{}] Na manhã seguinte, quando estávamos
...
ao recém"-incorporado subúrbio de \textit{datchas} de Zverinec, que foi rebatizado
...
periódicos, dentre eles 35 poloneses, 20 lituanos, sete russos, cinco judaicos
e dois bielorrussos.\footnote{Venclova, op. cit., p. 53.}
...
Na Páscoa de 1884, aos 9 anos de idade, Dobuzhinsky foi a Vilna pela
...
Em Vilna, pela primeira vez, deixando de lado duas ou três pinturas dos meus
...
para assistir, por 20 minutos inteiros, à passagem de carroças e
...
novembro de 1915; mas a privação física daqueles 16 meses gerou
...
tal cidade de \textit{Wilno}, onde ora todos são lituanos, ora ninguém.}{``Algumas aparências desconcertantes'' em \textit{A história de Wilno}}
\end{epigraphs}
...
40 anos, o pai abandonou a família e fugiu com a amante para
...
antipolonesas e antijudaicas -- e ainda tinha a rara qualidade da
...
quilômetros quadrados, habitada por 27 milhões de pessoas.
Dessas, 11 milhões vieram do antigo Congresso da Polônia; 8, da
Áustria; 4, da Prússia. Faltam 4 milhões: elas ocupam o
...
Haim Sloves,\footnote{Sloves nasceu em 1905 e morreu em 1988.} escritor e dramaturgo iídiche, descreve a
...
entidade do que em qualquer outra cidade importante. Aqui, 40\% da população é judaica e, aqui, como em qualquer outro lugar, eles
...
essas cruzes. Um canhão: os russos costumavam dispará"-lo às 12 horas
...
Guerra em 1º de setembro de 1939, como \textit{Wilno}, cidade polonesa; emergiu
...
A vasta maioria dos judeus de \textit{Vilnè} foi assassinada pelos alemães e
colaboradores lituanos em Ponari,\footnote{Ou Paneriai.} a colina verdejante do
...
Apesar de ter sido extremamente melancólica, a memória de \textit{Vilnè} no
...
transmitida pela tradição das \textit{yeshivot}. Nos Estados Unidos, \textit{Vilnè} é tida
...
de 14 pessoas. Passamos por ruelas estreitas, de paralelepípedo, e
...
com \textit{strass}, os dedos à vista. As unhas dos dedos da mão cintilavam de
...
constante de mortos com vozes e currículos contrastantes, além de lealdades
\textit{post"-mortem} antagônicas. Assim, a meu ver, os cemitérios e os
espaços memoriais de \textit{Vilnius} são limiares onde, no sentido \textit{bakhtiniano}
...
francesa. Na verdade, soldados de pelo menos 20 nações europeias
...
cerimonial dos restos ocorreu em 1º de junho de 2003. Eles agora
...
\begin{bibliohedra}
 \tit{abramowicz}, Hirsz. \textit{Profiles of a Lost World, Memoirs of East
  ...
  \tit{čepėnas}, Petras. \textit{Naujųjų laikų Lietuvos istorija, t. \textsc{ii}}.
  Vilna: Mokslo ir enciklopedijų leidykla, 1992.

  \tit{chesterton}, Gilbert Keith. \textit{Autobiography}. Londres: Hutchinson
  and Company, 1936.

  \tit{chicherin}, Aleksandr. \textit{Dnevnik Aleksandra Chicherina.} Ed.\,\textsc{s.\,g.}\,
  ...
  \tit{dobryanski}, \textsc{c.\,f.} \textit{K istorii otechestvenoi voiny. Sostoyania
  ...
  \tit{ffinch}, Michael. \textit{\textsc{g.\,k.}\,Chesterton}. Londres: Weidenfeld and
  Nicholson, 1986.
  ...
  \tit{kudrinskii}, \textsc{o.\,a.} \textit{Vilna v 1812 godu}. Vilna: 1912.
  ...
  \tit{lavrinec}, Pavel. Ed. \textit{Russkaja literature v Litve \textsc{xiv}--\textsc{xx} v}.
  ...
  \tit{matušakaitė}, Marija. \textit{Apranga \textsc{xvi}--\textsc{xviii} a. Lietuvoje}. Vilna:
  Aidai, 2003.
  ...
  \tit{ragauskas}, Aivas. \textit{Vilniaus miesto valdantysis elitas: \textsc{xvii} a.
  ...
  \tit{sukiennicki}, Wiktor. \textit{East Central Europe during World War \textsc{i}:
  ...
  \tit{ulčinaitė}, Eugenija, ed., \textit{Gratulatio Vilnè}. Vilna: Lietuvių
...
\tit{vinogradov}, \textsc{a.\,a.} \textit{Putevoditel pe gorodu Vilna i evo okrestnosiam}.
...
\tit{washburn}, Stanley. \textit{On the Russian Front in the World War \textsc{i}:
...
%história intimista e atraente. O autor divide com o leitor uma profunda
...
%precisão de um acadêmico e o coração de um contador de histórias.'' Dovid
