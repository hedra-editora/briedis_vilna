...
marcada por uma mudança simples e limitada de cores.''\footnote{Jacobson,
  Dan. \textit{Heshel's Kingdom,} London: Penguin Books, 1998, p. 109.}
...
como cochonilha polonesa.\footnote{Vide Ball Philip, \textit{Bright Earth:
...
estrangeira.''\footnote{Kulbak, Moshe, ``Vilna'', tradução de Nathan
  Halper, in Mošė Kulbakas, \textit{Vilnius}. Vilnius: Vaga, 1997, pp.
  17--19.}
...
escolha viver no paraíso terrestre tem que vir ao Brasil.''\footnote{Citado
  ...
  how to brew a Brazilian Stew'' in \textit{National Identities,} vol. 7,
...
realidade'' fora do quadro.\footnote{Huxley, Aldous. \textit{On Art and
...
nós {[}brasileiros{]}, pois tudo o é.''\footnote{Gomes, Paulo Emílio
  Sales, \textit{Cinema, trajetória no subdesenvolvimento}. Rio de
...
preparado por ele, os monumentais caracteres hebraicos.''\footnote{Segall,
  Lasar. Minhas recordações, in \textit{Lasar Segall: textos, depoimentos
  e exposições.} São Paulo: Museu Lasar Segall, 1993, p. 10. Citado em
  Giancarlo Hannud. ``Lasar Segall: de volta a Vilnius'' in \textit{Lasar
...
lugar triste e doloroso.''\footnote{Bardi, Pietro Maria. \textit{Lasar
...
orientais.''\footnote{Conforme citado em Wolfe, Edith, ```Exiled from
  ...
  \textit{KulturConfusão -- on German"-Brazilian Interculturalities,} pp.
  267--300 (\textit{Interdisciplinary German Cultural Studies,} vol. 19, De
...
sua paleta.''\footnote{Page, P.K., \textit{Brazilian Journal,} ed. Suzanne
...
esperança e desilusão.''\footnote{Conforme citado em Wolfe, Edith,
  ...
  Minhas recordações, in \textit{Lasar Segall: textos depoimentos e
...
cobertos de neve eterna.''\footnote{Guigonnat, Henri. \textit{Daemon in
...
``a severidade do norte.''\footnote{Miłosz, Czesław. \textit{The Issa
